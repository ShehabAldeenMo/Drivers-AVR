...
static u64 DESIRED_TIME_TIMER1 ;
static u16 PRE_SCALAR_TIMER1 ;
static f32 T_OV_TIMER1  ;
static f32 NUM_OV_TIMER1 ;
static f32 PRE_LOAD_TIMER1 ;
...
/******************** The part that use to count time  *************************/
//to check that you use OV
#if TIMER1_MODE == OV

void TIMER1_Set_Time_S (u8 Copy_U8Time){
/*************************************/
}

void TIMER1_Set_Time_mS (u16 Copy_U8Time){
/*************************************/
}
